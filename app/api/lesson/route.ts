...
export async function POST(req: Request) {
  try {
    ...
    // Call Gemini 2.5 Flash on stable v1 endpoint
...

{
  ...
  "slides": [
    { "id": 1, "title": "Гарчиг", "content": "1-р слайдын агуулга... Markdown формат (bold эсвэл жагсаалт) ашиглан илүү сонирхолтой жишээтэй бичих" },
    { "id": 2, "title": "Гарчиг", "content": "2-р слайдын агуулга... " }
  ],
  "quizzes": [
    {
